...
<header>
    <h1>Coordenador - Cadastro de Docentes</h1><br>
</header>
...
<div class="list-menu-cards"> <!-- enfiar um for aqui -->
    ...
    <form action="/JuquinhaEnsina/index.php" method="POST">
        <input type="hidden" name="page" value="/JuquinhaEnsina/Modules/Registries/teacherregistrycreate.php">
        <button type="submit">
            <p>Novo Docente</p>
        </button>
    </form>
    ...
    <form action="/JuquinhaEnsina/index.php" method="POST">
        <input type="hidden" name="page" value="/JuquinhaEnsina/Modules/Registries/teacherregistryedit.php">
