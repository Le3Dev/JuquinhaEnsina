<?php $back_page = '/JuquinhaEnsina/Modules/Registries/teacherregistryselect.php';  ?>
<?php include $_SERVER['DOCUMENT_ROOT'] . '/JuquinhaEnsina/Main/toolbar.php'; ?> 


<header>
    <h1>Coordenador - Cadastrar Docente</h1><br>
</header>
...
<div class="Registries"> 
    <div>
        <form action="/JuquinhaEnsina/index.php" method="POST">
            ...
            <input type="checkbox" name="Coordenator" id="Coordenator"> Tornar Coordenador <br>
